...
const ALL_GRANTS = [
  ...
  { key: 'view_revenue', label: 'Financial: View Revenue' },
  { key: 'view_profit', label: 'Financial: View Profit' },
  { key: 'export_data', label: 'Backup: Export Data' },
  { key: 'import_data', label: 'Backup: Import Data' },
