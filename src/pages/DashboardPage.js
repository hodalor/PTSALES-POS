...
function DashboardPage() {
  ...
  const metrics = useMemo(() => {
    ...
    return { todayTotal, itemsSold, lineData, paymentBar, doughData, topBar, stackedOptions, lineOptions, barOptions };
  }, [sales, products]);
    ...
    <div style={{ padding: 16 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12, marginBottom: 16 }}>
        <div style={{ background: '#fff', padding: 16, borderRadius: 12 }}>
          ...
          <div style={{ fontSize: 28, fontWeight: 700 }}>${metrics.todayTotal.toFixed(2)}</div>
        </div>
        <div style={{ background: '#fff', padding: 16, borderRadius: 12 }}>
        ...
        <div style={{ background: '#fff', padding: 16, borderRadius: 12 }}>
          ...
          <div style={{ fontSize: 28, fontWeight: 700 }}>{sales.length}</div>
        </div>
      </div>
